                  ...
                  <div className="relative mb-6 mr-12 flex flex-row items-start md:mb-0">
                    <div className="absolute mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-primary-light text-white">
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M502.3 190.8l-196.4 196.4c-6.2 6.2-16.4 6.2-22.6 0L108.3 190.8C102.1 184.6 102.1 174.4 108.3 168.2l196.4-196.4c6.2-6.2 16.4-6.2 22.6 0l196.4 196.4c6.2 6.2 6.2 16.4 0 22.6z"
                        ></path>
                      </svg>
                    </div>
                    <div className="ml-12 pt-2">
