      ...
      >
        <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <div className="project-img relative ">
            <img
              src="https://img-b.udemycdn.com/course/240x135/437398_46c3_10.jpg"
              alt="Course"
        ...
        <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <img
            src="https://img-b.udemycdn.com/course/240x135/947098_02ec_2.jpg"
            alt="Course"
            className="h-80 w-80 object-cover rounded-t-xl"
          />
          <div className="px-4 py-3 w-80">
        ...
        <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <img
            src="https://img-b.udemycdn.com/course/240x135/822444_a6db.jpg"
            alt="Course"
            className="h-80 w-80 object-cover rounded-t-xl"
          />
          <div className="px-4 py-3 w-80">
        ...
        <div className="w-80 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <img
            src="https://img-b.udemycdn.com/course/240x135/1463348_52a4_4.jpg"
            alt="Course"
            className="h-80 w-80 object-cover rounded-t-xl"
          />
          <div className="px-4 py-3 w-80">
